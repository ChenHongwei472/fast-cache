...
public interface RedisService {
     ...
     */
    <T> void setObject(final String key, final T value, final boolean saveTtl);
     ...
     * @return boolean
     */
    <T> boolean setObjectIfAbsent(final String key, final T value, final Duration duration);
     ...
     * @return boolean
     */
    <T> boolean setObjectIfExists(final String key, final T value, final Duration duration);
     ...
     * @return boolean
     */
    <T> boolean expire(final String key, final Duration duration);
     ...
     * @return 缓存的对象集合
     */
    <T> List<T> getObjects(final Collection<String> keys);
     ...
     * @return 剩余存活时间
     */
    <T> long getTimeToLive(final String key);
     ...
     * @param keys 键名的集合
     */
    <T> void deleteObjects(final Collection<String> keys);
     ...
     * @return boolean
     */
    boolean isExistsObject(final String key);
     ...
     * @return boolean
     */
    <T> boolean setList(final String key, final List<T> dataList);
     ...
     * @return boolean
     */
    <T> boolean addList(final String key, final T data);
     ...
     * @return 缓存的列表
     */
    <T> List<T> getListRange(final String key, int form, int to);
     ...
     * @return boolean
     */
    <T> boolean addSet(final String key, final T data);
     ...
     */
    <K, V> void setMap(final String key, final Map<K, V> dataMap);
     ...
     * @return 键集合
     */
    <T> Set<String> getMapKeySet(final String key);
     ...
     * @return 被删除的值
     */
    <T> T deleteMapValue(final String key, final String hKey);
     ...
     * @param hKeys 键值对映射
     */
    <T> void deleteMapValue(final String key, final Set<String> hKeys);
     ...
     * @return 所有键值对的 Map
     */
    <K, V> Map<K, V> getMapValue(final String key, final Set<K> hKeys);
     ...
     * @return 匹配的键集合
     */
    Collection<String> getKeys(final String pattern);
     ...
     * @param pattern 字符串前缀
     */
    void deleteKeys(final String pattern);
